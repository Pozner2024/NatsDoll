// Репозиторий галереи: читает активные фото из БД, отсортированные по полю position. 
// HOME_PREVIEW — фиксированный набор фото для превью на главной.                                   
// HOME_POOL — пул фото (случайная выборка — на уровне use-case)
