...
- [ ] **Step 1: Заменить содержимое `Dockerfile.web`**
...
- [ ] **Step 2: Локальная сборка образа**
...
- [ ] **Step 3: Прогон образа в сети dev-compose**
...
- [ ] **Step 4: Проверка CSP-совместимости (нет исполняемых inline-скриптов)**
...
- [ ] **Step 5: Остановить тестовый контейнер**
...
- [ ] **Step 2: Заменить статик-блок проксёй**
...
- [ ] **Step 2: Локальная валидация compose**
...
- [ ] **Step 1: Убрать мёртвый workspace**
...
- [ ] **Step 2: Sha-теги и чистка build-args**
...
- [ ] **Step 3: Локальная проверка web-тестов той же командой, что в CI**
...
- [ ] **Step 2: Отчёт пользователю и ожидание команды на релиз**
